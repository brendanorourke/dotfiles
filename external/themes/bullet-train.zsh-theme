...
# Modified: brendanorourke (6/9/2018)
# Change: Only show if *.(rb|ru) or Gemfile is present in the current directory.
prompt_ruby() {
...
# Go
# Modified: brendanorourke (6/9/2018)
# Change: Only show if *.go files present in current directory
prompt_go() {
...
# Modified: brendanorourke (6/9/2018)
# Change: Only show Node details in command line prompt if *.(js|json) files are present
